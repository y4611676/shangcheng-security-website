...
export const metadata: Metadata = {
  ...
  title: {
    default: '上誠通訊監視公司 - 專業弱電系統施工廠商 | 24小時智慧守護',
    template: '%s | 上誠通訊監視公司',
  },
  description: '上誠通訊監視公司提供專業弱電系統工程服務，包括監控系統、網路工程、門禁系統、保全系統等。採用最新 AI 智慧偵測技術，為家庭與企業打造全方位安全防護解決方案。',
  keywords: '監控系統,弱電工程,門禁系統,保全系統,網路工程,廣播系統,電話總機,對講機,AI智慧偵測,桃園監控,中壢監控,上誠通訊,監視系統,安全防護',
  authors: [{ name: '上誠通訊監視公司' }],
  creator: '上誠通訊監視公司',
  publisher: '上誠通訊監視公司',
  formatDetection: {
    email: false,
